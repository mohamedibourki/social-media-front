...
const testimonials = [
  {
    quote:
      "The support I received from Student Affairs was instrumental in my academic success.",
  ...
  {
    quote:
      "The career services team helped me land my dream internship at a top tech company.",
    author: "Michael Chen",
